...
object Compat_3_7_1 {
    ...
    fun TransactionBuilder.proposeBlockchainOperation(
        myPubkey: ByteArray,
        ...
        addOperation(
            "propose_blockchain",
            GtvFactory.gtv(myPubkey),
            GtvFactory.gtv(configData),
            GtvFactory.gtv(bcName),
            GtvFactory.gtv(containerName)
        )

    fun TransactionBuilder.proposeConfigurationAtOperation(
        myPubkey: ByteArray,
    ...
    fun TransactionBuilder.proposeConfigurationOperation(
        myPubkey: ByteArray,
        blockchainRid: BlockchainRid,
        configData: ByteArray
    ) =
